...
var areas_list: Dictionary = {
	'house': ['res://scenes/house/house.tscn', 'FromBeach'],
};
...
func _on_house_door_area_body_entered(body: Node2D) -> void:
...
func _on_house_door_area_body_exited(body: Node2D) -> void:
	if body as Player == null: return
	entity = null;
	area_entered = '';
